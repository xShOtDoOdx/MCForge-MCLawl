...
namespace MCForge {
	public static class SrvProperties {
		...
		public static void SaveProps(StreamWriter w) {
            ...
            if (String.IsNullOrEmpty(dogCsv)) w.WriteLine("zombie-level-list = #(Must be comma seperated, no spaces. Must have changing levels and use level list enabled.)"); //derp
            else w.WriteLine("zombie-level-list = " + dogCsv + "#(Must be comma seperated, no spaces. Must have changing levels and use level list enabled.)");
