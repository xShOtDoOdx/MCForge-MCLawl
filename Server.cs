...
namespace MCForge
{
	public class Server
	{
        ...
        internal static readonly List<string> devs = new List<string>(new string[] { "501st_commander", "Lavoaster", "Alem_Zupa", "bemacized", "Shade2010", "Dmitchell94", "edh649", "hypereddie10", "Snowl","Gamemakergm", "Serado", "Wouto1997", "cazzar", "givo", "headdetect" });
